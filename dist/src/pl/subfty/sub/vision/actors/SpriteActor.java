...
public class SpriteActor extends Actor{
	...
	public void setSprite(SPRITES sprite, float width){
		...
		this.width = width; 
		this.height = ((float)r.getRegionHeight())/((float)r.getRegionWidth())* this.width;
	}
	...
	public void fillScreen(){
		this.x = this.y = 0;
		this.width = LD25.SCREEN_WIDTH;
		this.height = LD25.SCREEN_HEIGHT;
	}
	@Override
