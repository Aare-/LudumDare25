...
public class BadKittyGame extends AScreen
  ...
  //GAME ACTORS
	...
	private boolean startedDeathAnim = false;
	...
	public void show() {
		...
		darkness.setSprite(SPRITES.BLOCK, LD25.STAGE_W, LD25.STAGE_H);
		darkness.color.set(0, 0, 0, 1);
		Tween.to(darkness, ActorAccessor.ALPHA, 3)
			 .target(0)
			 .start(LD25.tM);
		
		movable.x = (LD25.STAGE_W-houseFront.width*movable.scaleX)/2;
		movable.y = 0;
	}
	@Override
	public void hide() {
  ...
  //GETTERS
	...
	public PooOverlord getPooOverlord(){
		return pooO;
	}
  ...
  //CONTACT LISTENER
	...
	public void beginContact(Contact contact) {
		...
		if((userDataA != null && userDataA.getClass().getName().equals(Human.class.getName())))
			((Human)userDataA).collidedSearchNewDirection();
		if((userDataB != null && userDataB.getClass().getName().equals(Human.class.getName())))
			((Human)userDataB).collidedSearchNewDirection();
	}
	@Override
